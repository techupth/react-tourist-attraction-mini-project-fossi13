        ...
        {travels.map((travel, index) => {
          return (
            <div className="travel-list" key={index}>
              <aside>
                <img className="picture0" width={450} src={travel.photos[0]} alt="main-picture" />
              </aside>
              <body className="contanier">
                ...
                <p>{truncateDescription(travel.description)}</p>
                 ...
                 <p>หมวด : <span className="tag"> {travel.tags.join(' ')}</span> </p>
                 
                
                <div >
                  {travel.photos.slice(1).map((photo, index) => {
                    return <img className="allpicture" width={200} key={index + 1} src={photo} />;
                  })}
                </div>

                {/* <img  width={250} src={travel.photos[1]} alt="picture1" />
          <img  width={250} src={travel.photos[2]} alt="picture2" />
          <img  width={250} src={travel.photos[3]} alt="picture3" /> */}
